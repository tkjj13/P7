...
\begin{minipage}{.5\textwidth}
\begin{itemize}
\item Take a single reflection into account, reflected from the nearest surface.
\item Do not work at higher heights.
\item Is affected of changes in heights of the antennas.
\end{itemize}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
\begin{itemize}
\item Takes into account all the reflections from ATRPL and NSPL.
\item Works at all heights.
\item Is affected of height changes.
\end{itemize}
\end{minipage} \\
