...
\textcolor{red}{\textbf{Friss free space PL (FSPL)}:} 
...
\end{equation}
\\
\textcolor{blue}{\textbf{Approximated two-ray}}
\textcolor{blue}{\textbf{ground-reflection PL (ATRPL)}:} 
...
\end{equation}
\\
\textcolor{green}{\textbf{Norton surface wave PL (NSPL)}:} 
...
\label{surface_wave}
\end{equation}\\
\textcolor{purple}{\textbf{Ground wave PL (GWPL)}:} 
