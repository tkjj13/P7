...
The rest of the test parameters (Environment, Antenna type and Polarization) sample mean PL is seen in \autoref{App3}. It can be seen that be changing the parameter the mean PL varies between 2 dB and 4 dB.
